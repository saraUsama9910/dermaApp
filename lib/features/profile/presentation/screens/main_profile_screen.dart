              ...
              child: Stack(
                  ...
                  children: [
                    Container(
                      ...
                      decoration:
                          const BoxDecoration(color: AppColors.kkPrimaryColor),
                    ),
                          ...
                          child: Row(
                            children: [
                              ...
                              GestureDetector(
                                  ...
                                  child: SvgPicture.asset(
                                      ImageConstants.settingsForProfileIcon)),
                              SizedBox(
                                width: 16.w,
                              ),
                            ],
                        ...
                        children: [
                                            ...
                                            decoration: const BoxDecoration(
                                                ...
                                                image: DecorationImage(
                                                  image: CachedNetworkImageProvider(
                                                      'state.userAllDataModel.profilePictureUrl'),
                                                )),
                                          ),
                                        ),
                                      )
                          ...
                          state is GetUserDataSuccessState
                              ...
                              : PositionedDirectional(
                                  ...
                                  child: ResuableText(
                                    text: CacheHelper()
                                        .getData(key: ApiKeys.display_name),
                                    fontWeight: FontWeight.w600,
                                    fontSize: 20,
                                    color: AppColors.c121212,
                                  ),
                              ...
                              child: SizedBox(
                                ...
                                child: ListView.separated(
                                  ...
                                  itemBuilder: (context, index) =>
                                    ...
                                    profileItem:
                                        profileCubit.profileItems[index],
                                  ),
                                ),
                              ))
                        ],
